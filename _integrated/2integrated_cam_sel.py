...
available_midis = get_available_midis()
...
class PortFunctionMapper(QMainWindow):
    ...
    def __init__(self):
        ...
        midi_name = available_midis.keys()
    ...
    def get_selected_cam(self):
        ...
        cam_index = available_cams.get(current_cam)
    ...
    def get_selected_midi(self):
        ...
        midi_index = available_midis.get(current_midi)
