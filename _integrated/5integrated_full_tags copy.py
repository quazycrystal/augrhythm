...
def rotation_detection(frame, current_mappings):
    ...
    for tag in tags:
        ...
        tag_function = next((func for port, func, tone in current_mappings if port == tag_id), (None, None))
        tag_tone = next(((tone) for port, func, tone in current_mappings if port == tag_id), (None, None))
