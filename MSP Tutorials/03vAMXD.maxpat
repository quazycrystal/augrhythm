...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 494.0, 408.0, 96.0, 27.0 ],
					"style" : "",
					"text" : "Instrument"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 131.0, 408.0, 56.0, 27.0 ],
					"style" : "",
					"text" : "Effect"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 385.5, 128.0, 36.0, 26.0 ],
					"style" : "",
					"text" : "pack"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 385.5, 164.0, 119.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 385.5, 94.25, 110.0, 26.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 385.5, 11.5, 336.0, 53.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 155.5, 84.082581, 75.0, 26.0 ],
									"style" : "",
									"text" : "route param"
								}
...
,
					"patching_rect" : [ 548.0, 154.0, 83.0, 26.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 664.0, 164.0, 42.0, 26.0 ],
					"style" : "",
					"text" : "midiin"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 385.5, 201.0, 250.0, 196.0 ],
					"saved_object_attributes" : 					{
						"patchername" : [ "Big Ben Bell.amxd", "Big Ben Bell.amxd" ]
					}
,
					"snapshot" : 					{
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 408.0, 408.0, 45.0, 45.0 ],
					"style" : ""
				}
...
, 							{
								"box" : 								{
									...
									"fontsize" : 12.0,
									"id" : "obj-2",
									"items" : [ "amount", ",", "feedback", ",", "feedfwd", ",", "left", ",", "offset", ",", "right", ",", "speed_range", ",", "wet/dry" ],
									"maxclass" : "umenu",
									"numinlets" : 1,
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "" ],
...
,
					"patching_rect" : [ 226.0, 118.0, 83.0, 26.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal", "", "" ],
					"patching_rect" : [ 48.0, 164.0, 262.0, 196.0 ],
					"saved_object_attributes" : 					{
						"patchername" : [ "Comber.amxd", "Comber.amxd" ]
					}
,
					"snapshot" : 					{
						"filetype" : "C74Snapshot",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 48.0, 408.0, 45.0, 45.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 58.25, 11.5, 224.0, 92.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 7.0, 1.0, 342.0, 467.0 ],
					"style" : "panelBlue"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 354.0, 1.0, 399.0, 467.0 ],
					"style" : "panelGold"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 486.0, 123.625, 412.0, 123.625 ],
					"source" : [ "obj-13", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 626.0, 410.0, 655.0, 410.0, 655.0, 138.0, 557.5, 138.0 ],
					"source" : [ "obj-15", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 712.0, 85.125, 440.5, 85.125 ],
					"source" : [ "obj-19", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 235.5, 150.0, 57.5, 150.0 ],
					"source" : [ "obj-25", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 300.5, 357.0, 321.0, 357.0, 321.0, 114.0, 235.5, 114.0 ],
					"source" : [ "obj-3", 3 ]
				}
